...
class UtilityBasedGaussianNoiseSampler:
    """
    Class UtilityBasedGaussianNoiseSampler takes arguments as follows:
    ...
    def __set_feature_stds_list(self, data):
    ...
    def resample(self):
        ...
        self.__set_feature_stds_list(data1)
        #interesting set
